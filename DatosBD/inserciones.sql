--Intrucciones para la inserción de Pulp fiction--
INSERT INTO eventos (nombre, director, fecha, review, portada, enlace) VALUES ('Pulp fiction', 'Quentin Tarantino','1994-10-14',
            'Jules y Vincent, dos asesinos a sueldo con no demasiadas luces,
              ...
              ,ambos deben ponerse "manos a la obra". Su misión: recuperar un misterioso maletín.','img/pulp.jpg','https://www.filmaffinity.com/es/film160882.html');

INSERT INTO premios VALUES('1','1','1994: Oscar: Mejor guión original. 7 nominaciones, incluyendo Mejor película');
INSERT INTO premios VALUES('1','2','1994: Globo de Oro: Mejor guión. 6 nominaciones');
INSERT INTO premios VALUES('1','3','1994: Festival de Cannes: Palma de Oro');
INSERT INTO premios VALUES('1','4','1994: 2 Premios BAFTA: Mejor actor sec. (Samuel L. Jackson) y guión. 9 nom.');
INSERT INTO premios VALUES('1','5','1994: Premios Cesar: Nominada a Mejor película extranjera');
INSERT INTO premios VALUES('1','6','1994: Premios David di Donatello: Mejor film y actor extranjero (Travolta). 3 nom.');


INSERT INTO criticas VALUES('1','1','Emilio García','Sin lugar a dudas, la mejor película de Quentin Tarantino. La mezcla entre humor negro, y la violencia característica de este director, forman un trabajo excepcional. Debo recalcar que esta inusual forma de contar una historia (no lineal), hace que se vuelva muy dinámica y entretenida, sin caer en lo absurdo. Es una de las mejores películas de la historia, ya que fue un hito en la cultura popular y significó gran inspiración para el cine de Hollywood y el resto del mundo.');
INSERT INTO criticas VALUES('1','2','Maria Martín','La película tiene toques de humor bastante bien elaborados, los diálogos son bien presentados y en ningún momento tiene escenas lentas o aburridas, la historia tiene un ritmo bastante bueno y en general hacen un estupendo trabajo al formarla, más que la acción la película nos cuenta una verdadera historia con partes que hacen sentir intrigados y con ganas de ver más, una obra maestra.');

INSERT INTO escenas VALUES('1','1','img/escena1.jpg','Escena de John Travolta y Samuel L Jackson');
INSERT INTO escenas VALUES('1','2','img/escena2.png','Famosa escena de baile entre John Travolta y Uma Thurman');

INSERT INTO comentarios VALUES('1','1','Laura Benítez','Simplemente espectacular,para mi una de las mejores películas de la historia con un guion, unos diálogos y unos personajes que se superan en todo.','2020-3-21','20:15:06');
INSERT INTO comentarios VALUES('1','2','Miguel González','Cuando el cine elimina los efectos especiales, que desvían nuestra atención, uno solo puede creer en el guión de una película, y cuando esto sucede, solamente :Pulp Fiction puede hacerte pensar: QUE GRANDE ES EL CINE!!!','2020-3-21');

--Intrucciones para la inserción de El padrino--
INSERT INTO eventos (nombre, director, fecha, review, portada, enlace) VALUES ('The Godfather', 'Francis Ford Coppola','1972-10-20',
            'América, años 40. Don Vito Corleone (Marlon Brando) es el respetado y temido jefe de una de las cinco familias de la mafia de Nueva York.
             Tiene cuatro hijos: Connie (Talia Shire), el impulsivo Sonny (James Caan), el pusilánime Fredo (John Cazale) y Michael (Al Pacino),
              que no quiere saber nada de los negocios de su padre. Cuando Corleone, en contra de los consejos de "Il consigliere" Tom Hagen (Robert Duvall), se niega a 
            participar en el negocio de las drogas, el jefe de otra banda ordena su asesinato. Empieza entonces una violenta y cruenta guerra entre las familias mafiosas.
             ','img/padrino.jpg','https://www.filmaffinity.com/es/film809297.html');

INSERT INTO premios VALUES('2','1','1972: 3 Oscars: Mejor película, Actor (Marlon Brando), Guión adaptado');
INSERT INTO premios VALUES('2','2','1972: 5 Globos de Oro: Película (Drama), Director, Actor (Brando), Guión y BSO');
INSERT INTO premios VALUES('2','3','1972: 5 Premios BAFTA: Incluyendo mejor película y director. 7 nominaciones');
INSERT INTO premios VALUES('2','4','1972: Círculo de Críticos de Nueva York: Mejor actor secundario (Duvall). 4 nominaciones');
INSERT INTO premios VALUES('2','5','1972: National Board of Review: Mejor actor sec. (Pacino) y Mejores 10 films del año');
INSERT INTO premios VALUES('2','6','Sindicato de Directores (DGA): Mejor director');

INSERT INTO criticas VALUES('2','1','Carlos Boyero','"El padrino" son palabras mayores. Las dos primeras partes están entre las 10 mejores películas de la historia del cine.');
INSERT INTO criticas VALUES('2','2','Luis Martínez','Coppola inventa una nueva mirada para el cine y amplía los horizontes de una industria que pedía a gritos savia nueva.');

INSERT INTO escenas VALUES('2','1','img/padrino_escena_1.jpeg','Memorable escena con el gato');
INSERT INTO escenas VALUES('2','2','img/padrino_escena_2.jpeg','Famosa escena con la cabeza del caballo');



--Intrucciones para la inserción de Goodfellas--
INSERT INTO eventos (nombre, director, fecha, review, portada, enlace) VALUES ('Goodfellas', 'Martin Scorsese','1990-10-19',
            'Henry Hill, hijo de padre irlandés y madre siciliana, vive en Brooklyn y se siente fascinado por la vida que llevan los gángsters de su barrio,
             donde la mayoría de los vecinos son inmigrantes. Paul Cicero, el patriarca de la familia Pauline, es el protector del barrio. A los trece años, 
             Henry decide abandonar la escuela y entrar a formar parte de la organización mafiosa como chico de los recados; muy pronto se gana la confianza de sus jefes,
              gracias a lo cual irá subiendo de categoría.','img/unodelosnuestros.jpg','https://www.filmaffinity.com/es/film978961.html');

INSERT INTO premios VALUES('3','1','1990: Oscar: Mejor actor secundario (Joe Pesci). 6 nominaciones');
INSERT INTO premios VALUES('3','2','1990: Globos de Oro: 5 nom., incluyendo Drama, Director y Actor Sec. (Pesci)');
INSERT INTO premios VALUES('3','3','1990: Premios BAFTA: Mejor música. 5 nominaciones, incluyendo Mejor actor (Brando)');
INSERT INTO premios VALUES('3','4','1990: Festival de Venecia: León de Plata (Mejor director)');
INSERT INTO premios VALUES('3','5','1990: National Board of Review: Mejor Actor Sec. (Pesci), 10 mejores películas');
INSERT INTO premios VALUES('3','6','1990: Círculo de Críticos de Nueva York: Mejor película, director y actor. 6 nom.');

INSERT INTO criticas VALUES('3','1','Pablo Kurt','Scorsese estrena la década estampando una obra maestra en el subgénero del cine de mafia. "Uno de los nuestros" es una historia de ambiciones y lealtades,
                            es un puñetazo en la retina, es un escalofrío cortesía de un brutal Joe Pesci, es una sobredosis de cine de autor cortado de cine comercial... 
                            "Uno de los nuestros" es una las nuestras (películas favoritas).');

INSERT INTO criticas VALUES('3','2','Francisco Marinero','"Típica película de Scorsese: larga, densa, de esmero plástico y, narrativamente, dura y profunda. Los personajes están soberbiamente interpretados por Liotta, De Niro y Pesci. Muy buena"');

INSERT INTO escenas VALUES('3','1','img/goodfellas_escena_1.jpeg','Memorable escena del desayuno');
...
--Palabras prohibidas
INSERT INTO censura values(1,'puto');
INSERT INTO censura values(2,'Puto');
INSERT INTO censura values(3,'puta');
INSERT INTO censura values(4,'Puta');
INSERT INTO censura values(5,'mierda');
INSERT INTO censura values(6,'Mierda');
INSERT INTO censura values(7,'tonto');
INSERT INTO censura values(8,'Tonto');
INSERT INTO censura values(9,'subnormal');
INSERT INTO censura values(10,'Subnormal');
